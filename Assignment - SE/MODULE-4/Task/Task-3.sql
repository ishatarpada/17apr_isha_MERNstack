...
DELIMITER $$
    ...
    BEGIN
    	...
    	INSERT into `Employee` SET Employee_id = new.Employee_id ,First_Name = new.First_Name , Last_Name = new.Last_Name , 
        Sallery = new.Sallery ,Joining_Date = new.Joining_Date , Department = new.Department ;
