    ...
    <>
      <Container className="my-2">
        ...
        <div className="method-example">
          ...
          <button className="btn btn-outline-secondary" onClick={showAlert}>Show Alert</button>
          <code>
            {`alert('This is an alert message!');`}
          </code>
        </div>
        ...
        <div className="method-example">
          ...
          <button className="btn btn-outline-secondary" onClick={showConsoleLog}>Show Console Log</button>
          <code>
            {`console.log("This is a console log message");`}
          </code>
        </div>
        ...
        <div className="method-example">
          ...
          <button className="btn btn-outline-secondary" onClick={useDocumentWrite}>Use document.write()</button>
          <code>
            {`document.write('This is written using document.write()');`}
          </code>
        </div>
        ...
        <div className="method-example">
          ...
          <button className="btn btn-outline-secondary" onClick={useInnerHTML}>Use innerHTML</button>
