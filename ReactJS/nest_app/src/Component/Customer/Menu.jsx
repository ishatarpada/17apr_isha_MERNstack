  ...
  return (
    <>
      ...
      <div className="product container-fluid">
        <div className="flex justify-between items-center m-5 p-3 rounded">
              ...
              <div className="m-3 w-96" key={product.id}>
                <div className={`w-full max-w-sm  border border-gray-200 rounded-lg shadow`}>
                  <div className="flex justify-end px-4 pt-4">
                    <button id="dropdownButton" data-dropdown-toggle="dropdown" className="inline-blockpy-2 p-2 font-medium text-white text-xl flex justify-center items-center bg-gradient-to-r from-lime-400 via-lime-500 to-lime-700 hover:bg-gradient-to-br focus:from-red-400 focus:via-red-500 focus:to-red-700 rounded " type="button">
                      <TbHeart />
                    </button>
                  </div>
                  ...
                  <div className="px-5 pb-5">
                    ...
                    <div className="flex items-center justify-between my-2">
                      <span className="text-xl font-bold text-gray-900 ">{product.shopkeeper}</span>
                    ...
                    <div className="flex mt-4 md:mt-6">
                      <button type="button" className="py-2 px-4 font-medium text-white text-xl flex justify-center items-center bg-gradient-to-r from-green-300 via-green-400 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 rounded"><BsFillCartCheckFill />
