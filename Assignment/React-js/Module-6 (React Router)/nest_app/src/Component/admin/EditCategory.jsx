...
export default function EditCategory() {
  ...
  // edit contact data
  useEffect(() => {
    axios.get(`http://localhost:4000/category/${id}`).then((response) => {
  ...
  const AddCategoryFormHandler = (e) => {
    ...
    axios.put(`http://localhost:4000/category/${id}`, update).then(() => {
      // pass a message for added data
      Swal.fire({
        title: "Thanks",
        text: "Thanks your category updated  successfully",
        icon: "success"
      });
    ...
    <>
      ...
      <div className="flex">
        ...
        <div className="container overflow-hidden">
          ...
          <form onSubmit={AddCategoryFormHandler}>
            <div className="row">
              ...
              <div className="mx-auto col-md-10">
                <button type="submit" className="btn btn-success btn-lg w-25 mx-auto">Update category</button>
              </div>
            </div>
          </form>
        </div>
