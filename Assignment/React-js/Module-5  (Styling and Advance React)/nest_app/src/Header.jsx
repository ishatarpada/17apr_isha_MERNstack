  ...
  return (
    <>
      <header className='screen-header'>
        ...
        {/* Middle Navigation */}
        <nav className="bg-white container-fluid header-2">
            ...
            <div className="flex items-center justify-between">
              ...
              <ul className="flex flex-row mt-0 space-x-8 text-xl font-medium rtl:space-x-reverse">
                ...
                <li className="nav-item dropdown-center dropdown">
                  <a href="#" className="nav-link text-gray-900 hover:text-green-500 focus:text-green-500 dropdown-toggle" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    Home
                  </a>
                  <ul className="dropdown-menu px-5 border-none shadow" aria-labelledby="navbarDropdown">
                    <li><a className="dropdown-item hover:text-green-500" href="#">Home 1</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">Home 2</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">Home 3</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">Home 4</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">Home 5</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">Home 6</a></li>
                  </ul>
                </li>
                <li>
                  <a href="#" className="text-gray-900 hover:text-green-500 focus:text-green-500 ">About</a>
                </li>
                 <li className="nav-item dropdown-center dropdown">
                  <a href="#" className="nav-link text-gray-900 hover:text-green-500 focus:text-green-500 dropdown-toggle" id="navbarDropdown1" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    Vendor
                  </a>
                  <ul className="dropdown-menu px-5 border-none shadow" aria-labelledby="navbarDropdown1">
                    <li><a className="dropdown-item hover:text-green-500" href="#">Vendor Grid</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">Vendor List</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">Vendor Details 1</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">Vendor Details 2</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">Vendor Dashboard</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">Vendor Guide</a></li>
                  </ul>
                </li>
                <li>
                  <a href="#" className="text-gray-900 hover:text-green-500 focus:text-green-500 ">Menu</a>
                </li>
                 <li className="nav-item dropdown-center dropdown">
                  <a href="#" className="nav-link text-gray-900 hover:text-green-500 focus:text-green-500 dropdown-toggle" id="navbarDropdown1" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    Shop
                  ...
                  <ul className="dropdown-menu px-5 border-none shadow" aria-labelledby="navbarDropdown1">
                    <li><a className="dropdown-item hover:text-green-500" href="#">shop Grid Right Sidebar</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">shop Grid left Sidebar</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">shop List Right Sidebar</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">shop List Left Sidebar</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">Shop Wide</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">Shop Product</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">Shop Filter</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">Shop Cart</a></li>
                    <li><a className="dropdown-item hover:text-green-500" href="#">Shop Cart</a></li>
                  </ul>
                </li>
                <li>
                  <a href="#" className="text-gray-900 hover:text-green-500 focus:text-green-500">Blogs</a>
                </li>
                <li>
                  <a href="#" className="text-gray-900 hover:text-green-500 focus:text-green-500">Contact</a>
                </li>
              </ul>
